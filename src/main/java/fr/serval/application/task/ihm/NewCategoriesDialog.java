...
public class NewCategoriesDialog implements IHMComponentBuilder {
    ...
    public NewCategoriesDialog(TaskCategoriesView taskCategoriesView, int projectId) {
        this.taskCategoriesView = taskCategoriesView;
    ...
    public void setupComponent() {
        this.nameField.setPromptText("Nom de la categorie");
        this.descriptionField.setPromptText("Description de la categorie");

        this.createTask.setText("Ajouter la categorie");
        this.createTask.setOnAction(event -> this.addNewTask());
        ...
        this.dialogRoot.add(this.nameField, 0, 0);
        ...
        dialog.setTitle("Ajouter une categorie de tache");
    }
    ...
    private void addNewTask() {
        ...
        if (this.nameField.getText().isEmpty()) {
            this.statusText.setText("Le nom ne peux pas être vide");
            return;
        }
        ...
        APIController.getInstance().getAPITaskGroupController().addNewTaskGroupToProject(this.projectId, this.nameField.getText(), this.descriptionField.getText());

        this.taskCategoriesView.updateCategories();
        this.dialog.close();
    }
