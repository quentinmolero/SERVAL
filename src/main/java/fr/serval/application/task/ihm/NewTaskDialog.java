...
public class NewTaskDialog implements IHMComponentBuilder {
    ...
    private final int taskCategoriesId;

    public NewTaskDialog(TaskListView taskListView, int projectId, int taskCategoriesId) {
    ...
    public void setupComponent() {
        this.nameField.setPromptText("Nom de la tache");
        this.descriptionField.setPromptText("Description de la tache");
    ...
    private void addNewTask() {
        ...
        APIController.getInstance().getAPITaskController().addNewTaskToTaskGroup(this.taskCategoriesId, this.nameField.getText(), this.descriptionField.getText());

        this.taskListView.updateTasks(this.projectId, this.taskCategoriesId);
        this.dialog.close();
    }
